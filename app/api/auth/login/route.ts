...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    authorizationUrl.searchParams.set('redirect_uri', googleRedirectUri(request));
    ...
    return NextResponse.redirect(new URL('/?authError=configuration', appOrigin(request)));
  }
}
